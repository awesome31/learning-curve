/**
 * Recursion:
 * 1. Recursion is a pattern where a function calls itself again and again until
 ...
 * 4. The difference between a loop and recursion is that a LOOP does not have a
 * returning state. That is the strength of recursion.
 * 5. Static variables are created inside the code section of memory itself.
